...
You can find the blog post in Medium [here](https://towardsdatascience.com/analyzing-a-decade-of-nhl-hockey-e600103ee304)
...
The principal motivation of this work is to start looking at some answers to questions I have regarding the last decade's hockey results. I am going to answer the following questions based on the data I found in [Kaggle](https://www.kaggle.com/).
...
![Goalies](images/Average_Safe_Percentage_by_Goalie.png)
...
![Top 10 Goalies Avg. Save Percentage](images/Top_10_Goalies_Avg_Save_Percentage.png)
...
![Total goals by player (top 10)](images/Total_Goals_by_player.png)
...
![Top 10 Players Goals Per Game](images/Top_10_Players_Goals_per_Game.png)
...
![Average of total goals of the top 3 scorers per team](images/Avg_Top_3_Scorers_per_Team.png)
...
![Average Goals per game by Team](images/Avg_Goals_per_Game_per_Team.png)
...
![Top 10 players Penalty Minutes Per Game](images/Top_10_players_Penalty_Minutes_per_Game.png)
...
![Country that produces more NHL players from 2010–2019](images/Hockey_Country.png)
...
![Players by country table](images/Number_Players_Country_Table.png)
